///scr_attack_boss_hand(target, attacker)

if argument1.object_index == obj_arrow && argument1.owner != argument0.owner {
    argument0.hearts = max(argument0.hearts - 100, 0);
}

if argument0.state == STATE_COMBAT {
    exit;
}
